...
BOOL LoadMedia(){
	...
	//加载游戏背景纹理
	theApp.background.gback=load_image("./media/pics/background.jpg");
	...
	//加载星球纹理
	theApp.gplanet=load_image("./media/pics/plane.png");
	...
	//加载UFO纹理 
	theApp.ufo.gufo=load_image("./media/pics/ufo.png");
	...
	//加载血条纹理 
	theApp.blood.gblood=load_image("./media/pics/blood.png");
	if (!theApp.blood.gblood.mTexture)
	{
		printf("Failed to load gblood.\n");
		return FALSE; 
	} 
	theApp.blood.gbloodBg=load_image("./media/pics/bloodBg.png");
	...
	//加载炮弹纹理
	theApp.gbomb=load_image("./media/pics/bomb.png");
	...
	//加载爆炸纹理
	theApp.gexplosion=load_image("./media/pics/boom.png");
	...
	theApp.gFont = TTF_OpenFont( "./media/Semitalic.ttf", 56 ); 
	...
	//Load music
	theApp.gMusic = Mix_LoadMUS( "./media/audio/bgmusic.mp3" );
	...
	theApp.wavFire = Mix_LoadWAV( "./media/audio/fire.wav" );
	...
	theApp.wavBomb = Mix_LoadWAV( "./media/audio/bomb.wav" );
