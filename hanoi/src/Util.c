...
BOOL LoadMedia(){
	 ...
	 //加载游戏成功纹理
	theApp.gFont = TTF_OpenFont( "./media/Arial.ttf", 50 ); 
	...
	//加载数字纹理
	theApp.gFont = TTF_OpenFont( "./media/Arial.ttf", 18 );
	for (i=0;i<10;i++)
	{
	...
	//加载底座纹理
	theApp.towerLT=load_image("./media/pics/tower.png");
	...
	//加载圆盘纹理
	theApp.discsLT=load_image("./media/pics/discs.png");
