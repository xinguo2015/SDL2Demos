...
BOOL LoadMedia(){
	...
	//加载字体
	theApp.gFont = TTF_OpenFont( "./media/myFont.ttf", 28 );
	...
	//加载游戏背景纹理
	theApp.imgBackground=load_image("./media/pics/background.jpg");
	...
	//加载方块纹理
	theApp.imgBox=load_image("./media/pics/box.jpg");
	...
	//加载图形落地时的音频
	theApp.audio_attach = Mix_LoadWAV( "./media/audio/attach.wav" );
	...
	//加载鼠标进入按钮时的音频
	theApp.audio_levelUp = Mix_LoadWAV( "./media/audio/levelUp.wav" );
	...
	//加载得分时的音频
	theApp.audio_score = Mix_LoadWAV( "./media/audio/score.wav" );
