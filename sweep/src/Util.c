...
BOOL LoadMedia(){
	...
	theApp.imgFaces=load_image("./media/pics/430.bmp");
	...
	theApp.imgDigits=load_image("./media/pics/420.bmp");
	...
	theApp.imgBombs=load_image("./media/pics/410.bmp");
	...
	//加载开始游戏音频
	theApp.audio_start = Mix_LoadWAV( "./media/audio/start.wav" );
	...
	//加载自动翻面音频
	theApp.audio_reveal = Mix_LoadWAV( "./media/audio/reveal.wav" );
	...
	//加载爆炸音频
	theApp.audio_bomb = Mix_LoadWAV( "./media/audio/bomb.wav" );
	...
	//加载胜利音频
	theApp.audio_win = Mix_LoadWAV( "./media/audio/win.wav" );
	if( !theApp.audio_win)
	{
